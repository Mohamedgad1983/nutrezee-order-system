...
**Currently eligible: none — the NC-carry envelope (WP-01–06) is FULLY BUILT.** WP-07 is the frontier and is workshop-blocked (intake field set); WP-08+ depend on it or on later gates. Build resumes at the verification workshop (or a sponsor decision on the intake field set). Staging live + smoke-tested remains the hard WP-14/pre-pilot gate.
...
| WP-07 | Intake & WhatsApp panel | **BLOCKED 2026-06-10** | — | — | — | Hard NC: mandatory intake-field set (workshop S3 Q8) affects DoD; NC-carry covers WP-01–06 only — stop-rule applies. Unblock: workshop session 3 (or sponsor decision on the field set) |
