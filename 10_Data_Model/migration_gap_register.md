...
| MG-E3 | Perf baseline (no harness/thresholds) | eng | go-live gate (capacity confidence) | Author a light perf harness against staging; record p50/p95 for intake-create, review-approve, report-read | OPEN `[ENG]` — closeable now |
